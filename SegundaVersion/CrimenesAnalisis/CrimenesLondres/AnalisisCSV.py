...
# Leer el archivo csv de crimenes en Londres para limpiarlos antes de usarlos para Computación Multipartita Segura Cuántica
...
# major_category es la columna dedicada a los crímenes cometidos. Se deben buscar los valores únicos para poder traducirlos
...
num_delitos_distintos = df['major_category'].nunique()
