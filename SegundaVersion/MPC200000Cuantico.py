...
# Archivos CSV creados de 200000 filas
# Configuración de archivos
BASE_DIR = Path(__file__).resolve().parent
CARPETA_DATOS = BASE_DIR / "CantidadDatos"
ARCHIVOS = glob.glob(str(CARPETA_DATOS / "Municipal_Delitos_200000_*.csv"))
...
async def mpc_shamir_demo():
    ...
    for archivo in ARCHIVOS:
        ...
        delitos_col = df.iloc[:, 6].astype(str).tolist()  # Columna 7 = Tipo de delito
    ...
    # Generar shares y reconstruir secretos con componente cuántico
